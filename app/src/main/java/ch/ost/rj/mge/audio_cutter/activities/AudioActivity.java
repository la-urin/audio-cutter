...
//        }
    ...
    private void loadGui() {
        ...
        mEndText = findViewById(R.id.end_text);
        mEndText.addTextChangedListener(mTextWatcher);

        mPlayButton = findViewById(R.id.player_play);
        mPlayButton.setOnClickListener(mPlayListener);
        mRewindButton = findViewById(R.id.player_rew);
        mRewindButton.setOnClickListener(mRewindListener);
        mFfwdButton = findViewById(R.id.player_ffwd);
        mFfwdButton.setOnClickListener(mFfwdListener);

        TextView markStartButton = findViewById(R.id.label_start);
        markStartButton.setOnClickListener(mMarkStartListener);
        TextView markEndButton = findViewById(R.id.label_end);
        ...
        mInfo = findViewById(R.id.player_info);
